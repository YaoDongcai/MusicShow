<template>
	<view class="uni-swiper__warp">
		...
		<view v-if="mode === 'nav'" class="uni-swiper__dots-box uni-swiper__dots-nav" :style="{'background-color':dotsStyles.backgroundColor, 'width':'100% - 30rpx','margin-right': '15rpx', 'margin-left': '15rpx', 'display': 'none'}">
